    ...
    return [
      ...
      },
      {
        ...
        permissions: [
          ...
          { key: 'settings:view_smtp', label: 'Property SMTP', description: 'Access property-specific SMTP configuration.' },
          ...
          { key: 'settings:manage_smtp', label: 'Manage Property SMTP', description: 'Modify property-specific SMTP configuration.' },
