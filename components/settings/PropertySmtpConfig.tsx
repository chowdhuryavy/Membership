...
export const PropertySmtpConfig: React.FC<PropertySmtpConfigProps> = ({
  ...
  // Selected property state - defaults to currentProperty from context
  const [selectedPropertyId, setSelectedPropertyId] = useState<string>(
    currentProperty?.id || properties[0]?.id || ''
  );

  // Sync with currentProperty whenever top-bar selector changes
  useEffect(() => {
  ...
  // Load SMTP settings whenever the active property changes
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      <div className="bg-white rounded-[2.5rem] border border-slate-200/80 p-6 shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-sm font-black text-slate-900 uppercase tracking-tight">Active Property Scope</h3>
              <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">
                Configure dedicated outbound SMTP relay per luxury property
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
              ...
              <div>
                <div className="flex items-center gap-3">
                  <h2 className="text-xl font-black uppercase tracking-tight text-white">
                    {activeProperty?.name || 'Property'} • SMTP Relay
                  </h2>
                ...
                <p className="text-[11px] font-medium text-slate-400 mt-1">
                  All contracts, receipts, registration vouchers, and alerts for this property route through this server.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-4 py-2.5 rounded-xl bg-indigo-500/20 hover:bg-indigo-500/30 border border-indigo-400/30 text-indigo-200 text-xs font-black uppercase tracking-wider transition-all flex items-center gap-2"
              >
          ...
          <form onSubmit={handleSave} className="p-8 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-600 transition-all bg-white"
                  >
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-3 pr-11 rounded-xl border border-slate-200 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-600 transition-all"
                  />
                  <button
                    type="button"
            ...
            {formData.last_tested_at && (
              <div className={`p-4 rounded-2xl border flex items-center justify-between ${
                ...
                <button
                  type="button"
                  onClick={() => setShowTestModal(true)}
                  className="px-3 py-1.5 rounded-xl bg-white/80 hover:bg-white text-xs font-black uppercase tracking-wider shadow-sm border border-slate-200 transition-all"
                >
                  Retest
                </button>
              </div>
            ...
            <div className="flex items-center justify-end gap-4 pt-4 border-t border-slate-100">
              <button
                type="button"
                onClick={() => setShowTestModal(true)}
                className="px-6 py-3 rounded-2xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-black uppercase tracking-wider transition-all flex items-center gap-2"
              >
              ...
              <button
                type="submit"
                disabled={isSaving}
                className="px-8 py-3 rounded-2xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-black uppercase tracking-wider shadow-lg shadow-indigo-600/20 transition-all flex items-center gap-2 disabled:opacity-50"
              >
