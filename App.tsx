...
const Sidebar = ({ onLogout, isCollapsed, onToggle }: { onLogout: () => void, isCollapsed: boolean, onToggle: () => void }) => {
    ...
    const ALL_NAV_ITEMS = useMemo(() => {
        const items = [
            ...
            { id: 'pt-members', to: '/pt-members', icon: Dumbbell, label: 'PT Members', permission: 'pt_members:view' as Permission },
            { id: 'entrance-fee', to: '/entrance-fee', icon: Ticket, label: 'Entrance Fee', permission: 'entrance_fee:view' as Permission },
