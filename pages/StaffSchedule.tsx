  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans selection:bg-indigo-100">
      ...
      <header className="bg-slate-900 text-white sticky top-0 z-20 shadow-xl shadow-slate-900/10">
        ...
        <div className="relative z-10 flex justify-between items-center max-w-3xl mx-auto p-4 sm:p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-lg sm:text-xl font-black uppercase tracking-widest">{staff.name}</h1>
              <div className="flex items-center gap-2 mt-1">
                <span className="text-[10px] font-bold text-indigo-300 uppercase tracking-widest bg-indigo-900/50 px-2 py-0.5 rounded-md border border-indigo-500/30">
                  {staff.role}
                </span>
                {propertyName && (
          ...
          <div className="flex items-center gap-2">
            <button onClick={() => setShowPasswordModal(true)} className="p-2.5 bg-white/5 rounded-xl hover:bg-white/10 transition-colors text-slate-300 hover:text-white" title="Change Password">
              <KeyRound className="w-5 h-5" />
            </button>
            <button onClick={handleLogout} className="p-2.5 bg-red-500/10 rounded-xl hover:bg-red-500/20 transition-colors text-red-400 hover:text-red-300" title="Logout">
